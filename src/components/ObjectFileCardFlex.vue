      ...
      <div class="flex items-center w-full md:w-1/2">
          <div v-if="!object.dir && isOnSelect" class="flex items-start">
            <div class="flex items-center h-5">
               <input @change="onChangeSelect(object)" id="on-check-list" :checked="object.deleteMarker" name="on-check-list" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" />
            </div>
         </div>
